export default class abfalterEffectConfig extends ActiveEffectConfig {
    ...
    static initializeChangeKeys() {
        abfalterEffectConfig._availableChangeKeys = {
            ...
            'system.stats.Agility.opposedBonus': game.i18n.localize('abfalter.generalTab.opposed') + ' ' + game.i18n.localize('abfalter.agility'),
            'system.stats.Constitution.final': game.i18n.localize('abfalter.consti'),
            'system.stats.Constitution.opposedBonus': game.i18n.localize('abfalter.generalTab.opposed') + ' ' + game.i18n.localize('abfalter.consti'),
            'system.stats.Strength.final': game.i18n.localize('abfalter.strength'),
            'system.stats.Strength.opposedBonus': game.i18n.localize('abfalter.generalTab.opposed') + ' ' + game.i18n.localize('abfalter.strength'),
            'system.stats.Dexterity.final': game.i18n.localize('abfalter.dexerity'),
            'system.stats.Dexterity.opposedBonus': game.i18n.localize('abfalter.generalTab.opposed') + ' ' + game.i18n.localize('abfalter.dexerity'),
            'system.stats.Perception.final': game.i18n.localize('abfalter.perception'),
            'system.stats.Perception.opposedBonus': game.i18n.localize('abfalter.generalTab.opposed') + ' ' + game.i18n.localize('abfalter.perception'),
            'system.stats.Intelligence.final': game.i18n.localize('abfalter.intell'),
            'system.stats.Intelligence.opposedBonus': game.i18n.localize('abfalter.generalTab.opposed') + ' ' + game.i18n.localize('abfalter.intell'),
            'system.stats.Power.final': game.i18n.localize('abfalter.power'),
            'system.stats.Power.opposedBonus': game.i18n.localize('abfalter.generalTab.opposed') + ' ' + game.i18n.localize('abfalter.power'),
            'system.stats.Willpower.final': game.i18n.localize('abfalter.willPower'),
            'system.stats.Willpower.opposedBonus': game.i18n.localize('abfalter.generalTab.opposed') + ' ' + game.i18n.localize('abfalter.willPower'),
